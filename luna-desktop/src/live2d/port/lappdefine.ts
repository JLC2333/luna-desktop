...
export function setCanvas(c: HTMLCanvasElement | null): void { Canvas = c; }
export const CanvasSize: { width: number; height: number } | 'auto' = { width: 800, height: 800 };
